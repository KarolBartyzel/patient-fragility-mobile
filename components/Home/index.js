...
import { Text, Card, Searchbar, ActivityIndicator, Button } from 'react-native-paper';
...
class Home extends React.Component {
    ...
    render() {
        return (
            <Card style={{ flex: 1 }}>
                <Button style={{ margin: 'auto' }} icon="create" mode="contained" onPress={() => this.props.navigation.navigate('NewExamination')}>Nowe badanie</Button>
                <Card.Title
                    style={styles.header}
