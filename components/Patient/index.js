                        ...
                        <List.Item
                            ...
                            right={() => (
                                <View style={styles.patientDetailsTestButtons}>
                                    <IconButton icon="info" size={25} onPress={() => { this.props.navigation.navigate('PatientTest', { id: this.props.patientId, testId: test.id }); }} />
                                    <IconButton icon="add" size={25} onPress={() => { this.props.navigation.navigate('NewPatientTest', { id: this.props.patientId, testId: test.id }); }} />
                                </View>
                            )}
                        />
                    )}
